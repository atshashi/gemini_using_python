...
def categorize_sentence(sentence):
    prompt = "tell me the category of the sentance from [Sports,Achievements,Business,Corporate,Market Analysis,Science,Technology] and just give me name of the category in response :" +sentence
...
df['Category'] = df['Sentences'].apply(categorize_sentence)
